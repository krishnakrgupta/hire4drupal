 ...
 *   The form state.
 */
function hire4drupal_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['mtt_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('hire4drupal Theme Settings'),
    '#collapsible' => FALSE,
	'#collapsed' => FALSE,
  );
 ...
 $form['mtt_settings']['tabs']['responsive_menu']['responsive_menu_state'] = array(
	...
	'#default_value' => theme_get_setting('responsive_menu_state', 'hire4drupal'),
  );
 ...
 $form['mtt_settings']['tabs']['responsive_menu']['responsive_menu_switchwidth'] = array(
	...
	'#default_value' => theme_get_setting('responsive_menu_switchwidth', 'hire4drupal'),
  );
  ...
  $form['mtt_settings']['tabs']['responsive_menu']['responsive_menu_topoptiontext'] = array(
	...
	'#default_value' => theme_get_setting('responsive_menu_topoptiontext', 'hire4drupal'),
  );
